...
export class ProductPage {
    ...
    clickDelete() {
        if (confirm('Вы уверены, что хотите удалить этот фильм?')) {
            ajax.delete(stockUrls.removeMovieById(this.id), (data, status) => {
                ...
                <div class="product-info">
                    ...
                    <div class="product-actions">
                        ...
                        <div class="action-buttons-row">
                            ...
                            <button class="btn-delete-circle" id="delete-button" title="Удалить">
                                🗑
                            </button>
                        </div>
                    </div>
    ...
    getData() {
        ajax.get(stockUrls.getMovieById(this.id), (data) => {
            if (data) {
